...
packagedir = atomizer.__path__[0]


def get_config():
    conf = None
    try:
        fidx = os.listdir(packagedir).index("config.yml")
        config_file = os.path.join(packagedir, os.listdir(packagedir)[fidx])
